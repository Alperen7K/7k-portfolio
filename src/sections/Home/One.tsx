  ...
  <section id="one" className="">
   <div className="relative flex  h-[100vh] flex-col justify-end items-start text-white  bg-açıkGri">
    ...
    <div className="w-[100vw] z-20 h-[100vh] absolute pt-[100px] flex  justify-center bottom-0">
     <div className="flex flex-col lg:flex-row-reverse items-center lg:items-center lg:justify-evenly h-fit w-full   ">
      <div
       className="w-[40vh] lg:w-[30vw] h-[40vh] lg:h-[30vw] bg-center mt-8 bg-no-repeat bg-cover rounded-full border-[15px] border-solid border-gri"
       style={{ backgroundImage: `url(${alpi})` }}
      />
      <div className="lg:px-8 lg:py-4 lg:bg-gri rounded-full lg:border-[6px] border-solid border-white">
       <h1 className="text-center mt-16 lg:mt-0  text-[32px] font-bold">
