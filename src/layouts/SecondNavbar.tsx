...
export const SecondNavbar = () => {
 ...
 return (
  <div className="sticky  top-0 z-40 right-0 left-0 navbar-font text-white">
   ...
   <div className=" backdrop-blur-sm  w-full py-2 border-b-2 border-solid border-white flex items-center justify-center">
    <div className="w-[100vw] sm:w-[95vw] lg:w-[85vw] h-full    px-10   flex items-center justify-between">
     <label
      onClick={() => navigate("/")}
