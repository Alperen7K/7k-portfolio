...
export const Home = () => {
 ...
 return (
  <div className="m-0 p-0 w-[100vw] h-[100%] text-white">
   <div className="w-[100vw]  min-h-[90vh]   flex  justify-center bottom-0">
    <div className="flex flex-col min-h-full sm:h-full pb-20 lg:flex-row-reverse items-center lg:items-center lg:justify-evenly  w-full   ">
     <div
